...
Faiss in turn depends on Basic Linear Algebra Subprograms (BLAS) \remark{being available: w jakim znaczeniu}. In our experiments we have used
the \texttt{OpenBLAS} \cite{openblas} implementation, as it is fully open-source and easiest \remark{easier?} to install. One
